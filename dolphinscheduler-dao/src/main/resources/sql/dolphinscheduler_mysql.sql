...
CREATE TABLE `t_ds_platform_tenant` (
  ...
  `private_admin_token` varchar(255) DEFAULT NULL COMMENT 'private domain admin token',
  `private_deploy_ip` varchar(255) DEFAULT NULL COMMENT 'private domain deploy ip',
  `private_backend_port` varchar(32) DEFAULT NULL COMMENT 'private domain backend port',
  `private_db_type` varchar(64) DEFAULT NULL COMMENT 'private domain database type',
  `private_db_host` varchar(255) DEFAULT NULL COMMENT 'private domain database host',
  `private_db_port` varchar(32) DEFAULT NULL COMMENT 'private domain database port',
  `private_db_name` varchar(255) DEFAULT NULL COMMENT 'private domain database name',
  `private_db_user` varchar(255) DEFAULT NULL COMMENT 'private domain database user',
  `private_db_url` varchar(1024) DEFAULT NULL COMMENT 'private domain database url',
  `private_deploy_path` varchar(512) DEFAULT NULL COMMENT 'private domain deploy path',
  `private_process_check_command` text DEFAULT NULL COMMENT 'private domain process check command',
  `private_nginx_proxy_path` varchar(128) DEFAULT NULL COMMENT 'private domain nginx proxy path',
  `create_time` datetime DEFAULT NULL COMMENT 'create time',
  `update_time` datetime DEFAULT NULL COMMENT 'update time',
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT IGNORE INTO `t_ds_version` VALUES ('1', '3.4.2');
